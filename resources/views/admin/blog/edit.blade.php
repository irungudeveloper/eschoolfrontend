        ...
        <div class="col-md-12 p-3 ">
            <div class="card">
                <div class="card-header">
                    <p class="h3 text-center">Edit BlogPost/Event</p>
                </div>
                <div class="card-body">
                   
                    <form class="row g-3" method="POST" action="{{route('blog.store',$blog->blog->id)}}" enctype="multipart/form-data">
                      @csrf
                        <div class="col-md-12 mb-4">
                          <label for="blog_title" class="form-label">Blog Title</label>
                          <input type="text" class="form-control" id="blog_title" name="title" value="{{$blog->blog->title}}"> 
                        </div>
                        <div class="col-md-12 mb-4">
                        ...
                        <div class="col-12 mb-4">
                          ...
                          <textarea class="form-control" id="blog_description" name="description" rows="3">{{$blog->blog->description}}</textarea>                        
                        </div>
                        <div class="col-md-12 mb-4">
                        ...
                        <div class="col-12 mb-4">
                          <button type="submit" class="btn btn-success">Edit Blog/Event</button>
                        </div>
                      </form>
                </div>
            </div>
